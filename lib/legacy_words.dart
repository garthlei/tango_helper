...
import 'package:tango_helper/legacy_memorize.dart';
...
class LegacyWordListPage extends StatefulWidget {
  @override
  _LegacyWordListPageState createState() => _LegacyWordListPageState();
}

class _LegacyWordListPageState extends State<LegacyWordListPage> {
  @override
    ...
    return Scaffold(
        ...
        child: Row(
          children: [
            ...
            IconButton(
                ...
                onPressed: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => LegacyWordEditPage(callback: () {
                            setState(() {});
                          })));
                },
                color: lightColor),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: wordList.any((word) => !word.isDisabled)
            ? () {
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => LegacyMemoPage(callback: () {
                          setState(() {});
                        })));
              }
            : () => showDialog(
            ...
            .map((e) => Dismissible(
                  ...
                  child: ListTile(
                    ...
                    onTap: () => Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => LegacyWordDetailPage(
                              word: e,
                              callback: () {
                                setState(() {});
                              },
...
class LegacyWordDetailPage extends StatefulWidget {
  final Word word;
  final VoidCallback callback;

  @override
  LegacyWordDetailPage({this.word, @required this.callback});

  @override
  _LegacyWordDetailPageState createState() => _LegacyWordDetailPageState();
}

class _LegacyWordDetailPageState extends State<LegacyWordDetailPage> {
      ...
      appBar: AppBar(
        ...
        actions: [
          TextButton(
            ...
            onPressed: () {
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => LegacyWordEditPage(
                        callback: () {
                          setState(() {});
                          widget.callback();
                        },
...
class LegacyWordEditPage extends StatefulWidget {
  final Word word;
  final VoidCallback callback;

  @override
  LegacyWordEditPage({this.word, @required this.callback});

  @override
  _LegacyWordEditPageState createState() => _LegacyWordEditPageState(word);
}

class _LegacyWordEditPageState extends State<LegacyWordEditPage> {
  Word word;
  ...
  @override
  _LegacyWordEditPageState(this.word);
...
class LegacyAccentChip extends StatelessWidget {
...
class LegacyPosChip extends StatelessWidget {
  final bool isSelected;
  final String text;
  final void Function() onTap;

  @override
  LegacyPosChip({@required this.isSelected, @required this.text, this.onTap})
