...
class LegacyMemoPage extends StatefulWidget {
  final VoidCallback callback;

  @override
  LegacyMemoPage({@required this.callback});

  @override
  _LegacyMemoPageState createState() => _LegacyMemoPageState();
}

class _LegacyMemoPageState extends State<LegacyMemoPage> {
  int _index = 1;
...
class LegacyTestBody extends StatelessWidget {
  final Word word;
  final Mode mode;
  final VoidCallback callback;
  ...
  @override
  LegacyTestBody(
      {@required this.word, @required this.mode, @required this.callback})
...
class LegacyReviewBody extends StatelessWidget {
  final Word word;
  final Function(bool) callback;

  @override
  LegacyReviewBody({@required this.word, @required this.callback})
